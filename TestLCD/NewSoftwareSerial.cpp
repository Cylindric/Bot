...
#error This version of NewSoftwareSerial supports only 20, 16 and 8MHz processors
...
void NewSoftwareSerial::write(uint8_t b)
{
  if (_tx_delay == 0)
    return;
...
void NewSoftwareSerial::enable_timer0(bool enable) 
{
  if (enable)
